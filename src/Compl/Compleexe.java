...
public class Compleexe {
	...
	try {
		...
		Connection myConn2 = DriverManager.getConnection("jdbc:mysql://localhost/projetsoacomplexe?user=root&password=");
		
		PreparedStatement posted = myConn2.prepareStatement("insert into etudiant (cin,nom,apogee) values ('"+cin+"', '"+nom+"', '"+apog+"')");
		posted.executeUpdate();
		return "Inscription au complexe terminé et Etudiant ajouté à la base de donnée du complexe !";
